//#region constants
// commands
const PLAYER_LOGIN_COMMAND = "command-login";
const GAME_UPDATE_COMMAND = "command-game-update";
// events
const ERROR_EVENT = "error";
const PLAYER_CONNECTED_EVENT = "event-player-connected";
const PLAYER_DISCONNECTED_EVENT = "event-player-disconnected";
const GAME_UPDATE_EVENT = "event-game-update";
// game update events
const GAME_UPDATE_EVENT_NEW_PLAYER = "new-player-game-update";
//#endregion
